        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[70vh] pt-8 pb-12 lg:pt-12 lg:pb-16">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed font-normal">
                A premium digital ecosystem built to support autistic and
                neurodivergent adults across the UK through calming tools, safer
                online spaces, research intelligence, and inclusive support
                systems.
              </p>
              ...
              <div className="relative pl-4 py-1 border-l-2 border-primary/60">
                <p className="text-sm text-muted-foreground/90 font-medium italic leading-relaxed">
                  Most digital platforms ask neurodivergent people to adapt to
                  overwhelming environments. We believe technology should adapt
            ...
            >
              ...
              <Button
                variant="ghost"
                size="sm"
                className="rounded-full text-foreground transition-all duration-300 active:scale-[0.98] inline-flex items-center gap-1.5 h-10 px-4 sm:px-5 text-sm font-semibold bg-background/50 backdrop-blur-sm border border-gray-200 hover:bg-muted hover:border-border/80 hover:text-foreground"
              >
            ...
            >
              {[
                ...
                <span
                  key={label}
                  className="text-xs sm:text-sm font-medium text-muted-foreground flex items-center gap-1.5"
                >
          ...
          >
            ...
            <div className="relative w-full max-w-md rounded-3xl overflow-hidden bg-background/60 backdrop-blur-xl border border-border shadow-2xl">
              ...
              {/* SVG illustration */}
              <div className="px-6 pt-10 pb-8 flex justify-center"></div>
